...
const Logo = (props) => (
  <svg width={props.width} height={props.height} viewBox="0 0 2048 2048" xmlns="http://www.w3.org/2000/svg">
    ...
    <text className="title-text" id="TitleText" x="677.027" y="698.584" style={{fontFamily: 'Exo', fontSize: '182px', fontWeight: 'bold', letterSpacing: '24px', whiteSpace: 'pre'}}>Legato</text>
  </svg>
)
